...
export function FloatingSocial({ onWhatsAppClick }: FloatingSocialProps) {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      >
        <Instagram className="w-6 h-6 hover:text-pink-100 transition-colors duration-300 order-last md:order-none" />
